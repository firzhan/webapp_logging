...
public class RestUrls {
   ...
   // public static final String[] URL_DEPLOYMENT_COLLECTION = { SEGMENT_DEPLOYMENT_RESOURCE};
     ...
     */
    public static final String[] URL_DEPLOYMENT = {  "{0}"};
     ...
     */
    public static final String[] URL_PROCESS_DEFINITION_IDENTITYLINK = { SEGMENT_PROCESS_DEFINITION_RESOURCE, "{0}", SEGMENT_IDENTITYLINKS, "{1}", "{2}"};
